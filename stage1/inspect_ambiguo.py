# -*- coding: utf-8 -*-
"""
stage1/inspect_ambiguo.py — adjudication panel for the 12 AMBIGUO cases.
...
OUT = "inspect_ambiguo.png"
TH = 240   # lado do thumbnail

hum = {r["whst_input_file"]: r for r in csv.DictReader(open("data/inspecao_visual.csv", encoding="utf-8-sig"))}
