# -*- coding: utf-8 -*-
"""
varredura_limiar.py — the U-Net across the threshold, to compare against YOLO at the
...
Output: `stage3/unet_varredura.csv` (per image) and `stage3/unet_varredura_resumo.csv`
