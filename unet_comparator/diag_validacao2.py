# -*- coding: utf-8 -*-
"""
diag_validacao2.py — why does avalia() take 267 s AFTER training and 15 s on its own?

diag_fases showed validation consuming 73% of the epoch (267 s of 367 s), with the
wait for data at 0.1%. But diag_validacao measured the SAME function, on the SAME 197
images, in 15.1 s.
