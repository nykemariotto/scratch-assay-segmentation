...
if "yolo11m-seg" in res:
    ...
    print(f"    by parameters .... {r_par:>6.2f}x   <- misleading, see the header")
    if r_mac:
        print(f"    by MACs .......... {r_mac:>6.2f}x")
    if r_fwd:
    ...
    print(f"    U-Net per seed ... {lo*MEDIDO_YOLO_M_MIN/60:>5.1f} h  a  {hi*MEDIDO_YOLO_M_MIN/60:>5.1f} h")
