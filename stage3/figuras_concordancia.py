...
# -*- coding: utf-8 -*-
"""
stage3/figuras_concordancia.py — Figuras 3, 4 e 5 a partir do pareamento leakage-free.
...
SOURCE: `stage3/concordancia_final_longo.csv` (970 rows = 97 observations × 5 seeds
× 2 arms), produced by `stage3/concordancia_final.py`. The values in the captions
come from `stage3/concordancia_final.json`, read here — none is typed in.
...
# Okabe-Ito
AZUL, LARANJA, VERDE, ROSA, AREIA = "#0072B2", "#E69F00", "#009E73", "#CC79A7", "#F0E442"
...
Y = D["bracos"][BRACO]
with open("stage3/concordancia_final_longo.csv", encoding="utf-8-sig") as fh:
...
for i, (cl, tp, cor, mk) in enumerate(GRUPOS):
    ...
    ax.bar(i + larg / 2, ai.mean(), larg, yerr=ai.std(ddof=1), color=cor,
...
ax.axvline(2.5, color=CINZA, linewidth=0.6, linestyle=":")
