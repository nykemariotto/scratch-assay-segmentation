...
# -*- coding: utf-8 -*-
"""
stage3/stats_for_224.py — everything the manuscript's equivalence claim
...
[−δ, +δ]. Margins pre-specified in §2.8: ±0.10 (primary) and ±0.05 (sensitivity).
    ...
    python stage3/stats_for_224.py
"""
import csv
import math
import os
...
from _agreement_stats import ccc, tost      # noqa: E402  (definição única)
