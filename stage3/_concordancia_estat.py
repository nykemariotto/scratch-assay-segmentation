...
# -*- coding: utf-8 -*-
"""
stage3/_concordancia_estat.py — the agreement estimators, in ONE place.

WHY THIS MODULE EXISTS. `stage3/estatisticas_para_224.py` produced the numbers the
manuscript's Discussion already reports. `stage3/concordancia_final.py` needs the
