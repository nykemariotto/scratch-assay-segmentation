# -*- coding: utf-8 -*-
"""
stage3/iou_per_image.py — per-image mask IoU, for YOLO and U-Net, on the same basis.

WHY. The U-Net threshold sweep (`unet_comparator/threshold_sweep.py`) showed that
...
numbers being compared come from the same place.
    ...
    python stage3/iou_per_image.py
"""
import argparse
import csv
import glob
...
def main():
    ...
    saida = os.path.join("stage3", "iou_per_image.csv")
