# -*- coding: utf-8 -*-
"""
stage3/ablacao_padding.py — the padding ablation, paired by seed, PERSISTED to disk.
...
This script recomputes the pairing and WRITES `stage3/ablacao_padding.csv` and
`stage3/ablacao_padding.json`. It runs no bootstrap: the seed-paired statistic is
...
remains the responsibility of stage3/aggregate.py.
    ...
    python stage3/ablacao_padding.py
"""
import csv
import json
import math
...
with open(os.path.join("stage3", "ablacao_padding.csv"), "w", newline="",
          encoding="utf-8") as f:
...
json.dump({"contraste": f"{A} (black) - {B} (white)", "n_imagens_teste": 234,
          ...
          open(os.path.join("stage3", "ablacao_padding.json"), "w", encoding="utf-8"),
          indent=2, ensure_ascii=False)
print("\nwrote stage3/ablacao_padding.csv and .json")
