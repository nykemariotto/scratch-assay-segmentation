# -*- coding: utf-8 -*-
"""
stage3/figure1_study_flow.py — Figure 1, the study in one diagram.
...
AI-generated imagery for anything that represents data, and counts are data.
    ...
    python stage3/figure1_study_flow.py
"""
import csv
import glob
import json
...
def numeros():
    ...
    n["ref_closure"] = conta("data/closure_final_long.csv")
    tri = {}
    if os.path.isfile("data/visual_triage.csv"):
        for r in csv.DictReader(open("data/visual_triage.csv", encoding="utf-8-sig")):
