# -*- coding: utf-8 -*-
"""
stage3/figure6_example.py — Figure 6, the before/after panel, made reproducible.

WHY IT EXISTS. Figures 3, 4 and 5 come out of stage3/figures_agreement.py and can
...
def main():
    ...
    for ax, im, tit in ((axes[0], rgb, "Original (12 h after scratch)"),
                        (axes[1], over, "Automated segmentation")):
        ax.imshow(im)
