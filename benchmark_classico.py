# -*- coding: utf-8 -*-
"""
benchmark_classico.py — o braço clássico do A4 já está medido.
...
images that were later corrected by hand to become the reference standard.
  ...
  data/inspecao_visual.csv     -> blind visual triage of the automatic outputs
...
#   inspecao_visual.sorted_basename   HUVEC__…__121a1c1fcd.jpg
def md5pref(nome):
...
# ---------------------------------------------------------------- por serie
LONGO = ler("data/closure_final_longo.csv")
...
# ---------------------------------------------------------------- saida
with open("stage3/benchmark_classico_longo.csv", "w", newline="", encoding="utf-8") as f:
...
print(f"\nescrito: stage3/benchmark_classico_longo.csv ({len(comp)} linhas)")
